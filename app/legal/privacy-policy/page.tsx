      ...
      <main className="flex-grow py-12 px-4 sm:px-6 lg:px-8 flex justify-center">
        <div className="max-w-4xl w-full bg-white p-8 rounded-xl shadow-lg">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Derivative Data</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
              Information our servers automatically collect when you access the Site, such as your IP address, your browser type, your operating system, your access times, and the pages you have viewed directly before and after accessing the Site.
            </p>
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Financial Data</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Data From Contests, Giveaways, and Surveys</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-700 leading-relaxed space-y-2 ml-4">
              ...
              <li>Perform other bussiness activities as needed.</li>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">By Law or to Protect Rights</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Marketing Communications</h3>
            <p className="text-gray-700 leading-relaxed">
